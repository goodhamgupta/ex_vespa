defmodule ExVespa.Package.Schema do
  ...
  ## Examples
    ...
    iex> rank_profile = RankProfile.new("default", "1.25 * bm25(title) + 3.75 * bm25(body)", "default", %{c1: 1.0}, [Function.new("f1", "x + 1")], ["summary_feature"], SecondPhaseRanking.new("expression"), [{"title", 200}, {"body", 100}], [{"body", "about"}], [{"fieldMatch(title).maxAlternativeSegmentations", "10"}])
